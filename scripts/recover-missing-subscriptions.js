...
async function main() {
  ...
  for (const payment of paidPayments) {
    ...
    if (existingSub) {
      console.log(`OK: ${payment.user.email} — subscription sudah ada (${existingSub.redeemCode}), kirim email...`);
      try {
            ...
            <div style="font-family:Arial,sans-serif;max-width:500px;margin:0 auto;padding:20px;">
              ...
              <div style="background:#f9fafb;padding:30px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 10px 10px;">
                ...
                <div style="background:white;border:2px dashed #667eea;border-radius:8px;padding:20px;text-align:center;margin:20px 0;">
                  ...
                  <p style="font-size:32px;font-weight:bold;margin:0;letter-spacing:5px;font-family:monospace;">${existingSub.redeemCode}</p>
                </div>
