...
async function main() {
  ...
  for (const payment of paidPayments) {
    ...
    console.log(`CREATED: ${payment.user.email} — plan: ${planSlug}, redeemCode: ${redeemCode}`);
            ...
            <div style="background:#f9fafb;padding:30px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 10px 10px;">
              ...
              <div style="background:#ecfdf5;border-radius:8px;padding:15px;margin:20px 0;">
                <p style="margin:0;font-size:14px;">
                  <strong>Paket:</strong> ${planSlug.charAt(0).toUpperCase() + planSlug.slice(1)}<br>
                  <strong>Berlaku:</strong> 30 hari
                </p>
              </div>
